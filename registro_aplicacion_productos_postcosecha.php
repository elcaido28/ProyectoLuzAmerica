            ...
            <div class="x_content">
              <form id="formulario" class="formulario" action="" method="post" enctype="multipart/form-data">
                <fieldset class="fieldset_normal">
                  <h2>De productos en Post Cosecha</h2>
                  <hr>
                  <!-- <h3>algunas configuraciones</h3> -->
                  <div class="cont_caja2">
                    <label class="etiq_caja">Problema a tratar o controlar</label>
                  ...
                  <div class="cont_cajas_peque">
                    <label class="etiq_caja">Nombre del Producto</label>
                    <input type="txt" name="nombres" value="" placeholder="Nombre Comercial" onkeypress="return sololetras(event)" onpaste="return false">
                  </div>
                  <div class="cont_cajas_peque">
                    <label class="etiq_caja">Ingrediente Activo</label>
                    <input type="txt" name="apellidos" value="" placeholder="" onkeypress="return sololetras(event)" onpaste="return false">
                  </div>
                  
                  <div class="cont_cajas_peque">
                    <label class="etiq_caja">Dosis</label>
                    <input type="text" name="telefono" id="telefono">
                  </div>
                  <div class="cont_cajas_peque">
                    <label class="etiq_caja">Fecha de siembra</label>
                    <input type="date" id="fecha" name="fecha_naci" value="" placeholder="" onchange="fecha_edad(this.value);" >
                  </div>
                
                  <div class="cont_caja2">
                    <label class="etiq_caja">Observaciones</label>
