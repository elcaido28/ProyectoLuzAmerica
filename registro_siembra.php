              ...
              <form id="formulario" class="formulario" action="" method="post" enctype="multipart/form-data">
                <fieldset class="fieldset_normal">
                  ...
                  <div class="cont_cajas_peque">
                    <label class="etiq_caja">Identificación del Lote</label>
                  ...
                  <div class="cont_cajas_peque">
                    <label class="etiq_caja">Variedad</label>
                    <input type="txt" name="nombres" value="" placeholder="" onkeypress="return sololetras(event)" onpaste="return false">
                  </div>
                  <div class="cont_cajas_peque">
                    <label class="etiq_caja">Cantidad de Semillas</label>
                    <input type="txt" name="apellidos" value="" placeholder="" onkeypress="return sololetras(event)" onpaste="return false">
                  </div>
                  <div class="cont_cajas_peque">
                    <label class="etiq_caja">Material de Siembra/transplante</label>
                    <input type="text" name="telefono" id="telefono">
                  </div>
                  <div class="cont_cajas_peque">
                    <label class="etiq_caja">Procedencia de la semilla o material vegetal</label>
