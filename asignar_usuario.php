              ...
              <form id="formulario" class="formulario" action="guardar_usuario.php?id=<?php echo $ide; ?>" method="post" enctype="multipart/form-data">
                <fieldset class="fieldset_normal">
                  ...
                  <div class="cont_cajas_peque">
                    ...
                    <input type="txt" name="usuario" value="<?php echo $row['cedula']; ?>" placeholder="" onkeypress="return sololetras(event)" onpaste="return false" <?php if ($row2['clave']!='') {?> disabled <?php } ?> >
                  </div>
                  <div class="cont_cajas_peque">
