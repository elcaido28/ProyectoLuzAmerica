              ...
              <form id="formulario" class="formulario" action="guardar_empleados.php" method="post" enctype="multipart/form-data">
                <fieldset class="fieldset_normal">
                  ...
                  <div class="cont_cajas_peque">
                    ...
                    <input type="date" id="fecha" name="fecha_naci" value="" placeholder="" required onchange="fecha_edad(this.value);" >
                  </div>
                  <div class="cont_cajas_peque">
                  ...
                  <div class="cont_cajas_peque">
                    ...
                    <select class="F_combo" name="privilegio" required><option value="" >-SELECCIONE-</option>
